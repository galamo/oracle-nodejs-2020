...
getMoviesFromServer("avatar").then((data) => { console.log(data) }).catch((ex) => { console.log(ex) })
getMoviesFromServer("bbb").then((data) => { console.log(data) }).catch((ex) => { console.log(ex) })
